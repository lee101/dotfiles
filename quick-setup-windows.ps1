...
# ==========================================
if (-not $SkipNvim) {
    Write-Host "[4/4] Setting up Neovim (Windows + Git Bash) + text-generator-nvim..." -ForegroundColor Green
    ...
    Write-Host "[4/4] Skipping Neovim + text-generator-nvim (--SkipNvim)" -ForegroundColor DarkGray
}
...
# ==========================================
if (-not $SkipDotfiles) {
    Write-Host "[5/5] Linking remaining dotfiles..." -ForegroundColor Green
    ...
    Write-Host "[5/5] Skipping dotfiles linking (--SkipDotfiles)" -ForegroundColor DarkGray
}
